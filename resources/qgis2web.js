...
map.getView().fit([-1.425654, 6.814649, -1.416696, 6.819046], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">JUABEN WATER SYSTEM MAP</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (961 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Map of Juaben Water System Network, indicating the transmission and distribution network as well as other components such as valves, nodes/appurtenances, fire hydrants and storage tanks. The water system has a transmission network of 4.12Km (4122m), a distribution network of 18.94Km (18,941m), 2No. Fire Hydrants, 3No. Storage Tanks, 5No. Boreholes and 3No. Pump Houses. For the Purpose of asset management visuals on components include description, functionality and condition assessment and a picture at the time of inspection. <br /><br />Condition Assessment Codes; 5- (New/nearly new) No maintenance needed, 4- (Good)Minor maintenance needed, 3- (Fair) Routine Maintenance needed, 2- (Poor) Major maintenance needed, 1- (Failed) Replacement needed. <br /><br />Functionality Codes; 0- Not functional/Not in use, 1- Functional/In use<br /><br />Characteristic Condition codes: 1- Exposed, 2- Buried, 3- Rusting, 4- Broken, 5- Leaky, 6- Okay, 7- In an open chamber<br />Data captured in 2023.';
            }
